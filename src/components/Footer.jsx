export default function Footer() {
  return (
    <footer
      id="contact"
      className="border-t border-slate-800/60 py-16"
    >
      <div className="max-w-5xl mx-auto px-6">
        <div className="grid sm:grid-cols-2 gap-10 mb-12">
          ...
          <div className="flex flex-col justify-center gap-4">
            ...
            >
              <div className="w-8 h-8 rounded border border-slate-800 bg-slate-900 flex items-center justify-center group-hover:border-blue-400/30 transition-colors">
        ...
        <div className="pt-6 border-t border-slate-800/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
