const jobs = [
  {
    ...
    current: true,
    bullets: [
      'Lead signal optimization deployments for an AI traffic platform across Phoenix, Topeka, Missouri City, West Allis, Naples, and Montreal — managing 72+ signalized intersections from initial setup through validated before/after performance reporting.',
      'Delivered measurable delay reductions across major corridors: Missouri City SH6 cut per-vehicle delay ~10% while absorbing ~15% volume growth (16 intersections); West Allis Greenfield Avenue achieved ~25% corridor-wide delay reduction.',
      'Primary liaison between R&D (Israel) and U.S. field operations — translating traffic engineering requirements into actionable algorithm modifications and product improvements.',
      'Manage ongoing system health nationwide: monitoring, troubleshooting, agency training, and technical sales support for new deployments.',
    ],
