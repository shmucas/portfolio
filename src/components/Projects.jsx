const projects = [
  ...
  },
  {
    ...
    description:
      'An AI-agent-orchestrated toolkit that turns live Metabase signal data into NoTraffic\'s three standard ESG deliverables. Built as a set of auto-activating Claude Code skills — each encoding a complete analyst workflow (data pull, analysis, charting, and brand-styled document assembly) — so the agent recognizes the request, selects the right procedure, and produces a finished .pptx or .docx end-to-end.',
    details: [
      'Architected three self-contained Claude Code agent skills (SKILL.md-driven) that auto-activate from natural-language requests — TPM workshop deck, Signal Optimization Evaluation Report, and Intersection Health Dashboard.',
      'Wired a custom Metabase MCP server into the agent, exposing live SQL querying as a first-class tool with a parallel API-key fallback path for resilience.',
      ...
      'Engineered domain logic for HCM floating peak-hour detection, before/after corridor delay, RLR, AOG, and volume analysis with Economist-style chart rendering.',
    ...
    tags: ['Claude Code', 'AI Agents', 'MCP', 'Python', 'Metabase', 'python-pptx', 'python-docx', 'HCM 7th Edition'],
    accent: 'violet',
    private: true,
  },
  {
