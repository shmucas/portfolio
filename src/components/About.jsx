...
export default function About() {
  return (
    <section id="about" className="py-16 border-t border-ink-800 scroll-mt-6">
      ...
      <div className="space-y-4 max-w-2xl">
        <p className="text-ink-300 text-base leading-relaxed">
          ...
          <span className="text-ink-50 font-medium">NoTraffic</span>, a Series C AI
      ...
      <div className="mt-8">
        ...
        <p className="text-ink-100 text-sm font-medium">Georgia Institute of Technology</p>
        <p className="text-ink-400 text-sm">B.S. Civil Engineering</p>
        <p className="text-ink-500 text-xs font-mono mt-1">2018 – 2021</p>
      </div>
    </section>
  )
}
