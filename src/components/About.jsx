        ...
        <div className="grid md:grid-cols-5 gap-12 items-start">
          <div className="md:col-span-3 space-y-4">
            <p className="text-slate-300 text-lg leading-relaxed">
              ...
              <span className="text-slate-100 font-medium">NoTraffic</span>, a Series C AI
            ...
            <p className="text-slate-400 leading-relaxed">
              Before NoTraffic I was at <span className="text-slate-200 font-medium">Q-Free ASA</span>,
              ...
              <span className="text-slate-200 font-medium">HNTB</span> covered traffic
